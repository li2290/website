        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <View style={{height: screen.width / 8, width: screen.width, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around', backgroundColor: '#ffffff'}}>
                    <View style={{width: '25%', height: '70%', borderRightWidth: screen.onePixel, borderColor: color.border, alignItems: 'center'}}>
                        <Tip>动态</Tip>
                        <Normal>10</Normal>
                    </View>
                    <View style={{width: '25%', height: '70%', borderRightWidth: screen.onePixel, borderColor: color.border, alignItems: 'center'}}>
                    ...
                    <View style={{width: '25%', height: '70%', alignItems: 'center'}}>
